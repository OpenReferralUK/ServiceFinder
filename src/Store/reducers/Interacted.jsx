import { ADD_CIRCUMSTANCE, ADD_NEED, REMOVE_ALL, SAVE_AGE, SAVE_ANSWERSQUESTIONS, SAVE_DAY, SAVE_GENDER, SAVE_POSTCODE, SAVE_PROXIMITY, SAVE_TEXT, SAVE_TYPEOFSERVICE } from "../Actions/types";
